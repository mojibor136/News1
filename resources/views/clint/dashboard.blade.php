    ...
    <div class="admin-container">
        <div class="chat-container owl-carousel owl-theme" id="three-card">
            <div class="post-container">
                ...
                <div>
                    <div class="count">{{ ClintPostCount() }}</div>
            ...
            <div class="visitor-container">
                ...
                <div>
                    <div class="count">{{ ClintViewPostCount() }}</div>
        ...
        <div class="post-content">
            <div class="container mt-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h2>Posts</h2>
                    <a href="{{ route('clint.add.post') }}"class="btn btn-primary">Add Post</a>
                </div>
                        ...
                        <tbody>
                            @foreach ($posts as $post)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('clint.view.post', $post->id) }}"
                                            class="btn btn-secondary btn-sm">
                                            <i class="ri-eye-line"></i>
                                        </a>
                                        <a href="{{ route('clint.edit.post', $post->id) }}"
                                            class="btn btn-sm btn-info">Edit</a>
                                        <a href="{{ route('clint.delete.post', $post->id) }}"
