...
class ReporterPostController extends Controller {
    public function Index() {
        ...
        ->where( 'role', 'reporter' )
        ->paginate( 10 );
        return view( 'reporter.all-post', compact( 'posts' ) );
    }
    ...
    public function AddPost() {
        ...
        return view( 'reporter.add-post', compact( 'districts', 'subdistricts', 'categories', 'sub_categories' ) );
    }
    ...
    public function StorePost( Request $request ) {
        ...
        return redirect()->route( 'reporter.all.post' )->with( 'success', 'Post created successfully!' );
    }

    public function DeletePost( $id ) {
        Post::findOrFail( $id )->delete();

        return redirect()->route( 'reporter.all.post' )->with( 'success', 'Post deleted successfully!' );
    }
    ...
    public function EditPost( $id ) {
        ...
        $categories = Category::all();
        $sub_categories = SubCategory::all();
        return view( 'reporter.edit.edit-post', compact( 'districts', 'subdistricts', 'categories', 'sub_categories', 'posts' ) );
    }
    ...
    return redirect()->route('reporter.all.post')->with('success', 'Post updated successfully!' );
    }

    public function ViewPost( $id ) {
        $posts = Post::findOrFail( $id );
        return view('reporter.post-view',compact('posts' ) );
    }
}
