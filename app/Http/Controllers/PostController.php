...
class PostController extends Controller {
    public function Index() {
        ...
        return view( 'admin.all-post', compact( 'posts' ) );
    }
    ...
    public function AddPost() {
        ...
        return view( 'admin.add-post', compact( 'districts', 'subdistricts', 'categories', 'sub_categories' ) );
    }
    ...
    public function EditPost( $id ) {
        ...
        $categories = Category::all();
        $sub_categories = SubCategory::all();
        return view( 'admin.edit.edit-post', compact( 'districts', 'subdistricts', 'categories', 'sub_categories', 'posts' ) );
    }
